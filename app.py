...
def multi_cust(file, form):
    if file:
        ...
        form.table(cust_ID_DF)
        # Download button for the file
        form.download_button(label='Download table', data=data_frame, mime='text/csv',
...
# Selection
rad_b = sl.radio('Please select whether you want to give data for a single customer or multiple customers',
